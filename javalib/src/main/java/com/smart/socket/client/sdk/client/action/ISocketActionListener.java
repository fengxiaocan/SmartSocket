...
public interface ISocketActionListener {
     ...
     * @param data   写出的数据{@link ISendPack}
     */
    void onSocketWriteResponse(ConnectionInfo info, String action, ISendPack data);

    /**
     * Socket心跳发送后的回调<br>
     * 心跳发送是一个很特殊的写操作<br>
     * 该心跳发送后将不会回调{@link #onSocketWriteResponse(ConnectionInfo, String, ISendPack)}方法<br>
     *
     * @param info 这次连接的连接信息
     * @param data 心跳发送数据{@link IPulseSender}
     */
    void onPulseSend(ConnectionInfo info, IPulseSender data);
