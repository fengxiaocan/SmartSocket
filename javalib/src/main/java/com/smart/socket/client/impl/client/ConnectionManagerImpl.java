...
import com.smart.socket.client.impl.exceptions.UnConnectException;
import com.smart.socket.client.sdk.client.ConnectionInfo;
import com.smart.socket.client.sdk.client.OkSocketOptions;
import com.smart.socket.client.sdk.client.OkSocketSSLConfig;
...
public class ConnectionManagerImpl extends AbsConnectionManager {
    ...
    @Override
    public IConnectionManager send(ISendPack sender) {
        if (mManager != null && sender != null && isConnect()) {
            mManager.send(sender);
        }
        return this;
    }
