...
import static com.smart.socket.server.action.IAction.Server.ACTION_SERVER_ALLREADY_SHUTDOWN;
import static com.smart.socket.server.action.IAction.Server.ACTION_SERVER_LISTENING;
import static com.smart.socket.server.action.IAction.Server.ACTION_SERVER_WILL_BE_SHUTDOWN;
